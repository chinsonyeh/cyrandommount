...
- **Dismount behavior (DismountOnFly):** When enabled, pressing the macro while mounted will only dismount you if you're not flying. Hold Ctrl while pressing the macro to force a dismount even while flying.
